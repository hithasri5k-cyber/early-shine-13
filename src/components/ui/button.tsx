  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-white hover:scale-105 shadow-medical hover:shadow-xl transition-all duration-300 border-0",
        medical: "bg-accent text-accent-foreground hover:bg-accent/90 shadow-soft",
        health: "bg-health-orange text-health-orange-foreground hover:bg-health-orange/90 shadow-soft hover:shadow-medical",
        calm: "bg-gradient-calm text-white hover:bg-accent/90 shadow-soft",
      },
      size: {
